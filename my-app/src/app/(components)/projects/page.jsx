  ...
  const [allProjects] = useState([
    {
      ...
      scale: "large",
      desc: "We are looking for experienced cloud architects to migrate our on-premise infrastructure to AWS. The project involves moving 50+ applications, databases, and ensuring zero downtime during migration.",
      duration: "6 months",
      startDate: "2025-11-01",
      requirements: "AWS Certified Solutions Architect, Experience with enterprise migrations, Knowledge of Docker and Kubernetes",
      deliverables: "Complete cloud infrastructure, Migration documentation, Training for internal team",
      skills: "AWS, Docker, Kubernetes, Terraform, Python",
      bidDeadline: "2025-11-15",
      urgency: "high",
    ...
    },
    {
      ...
      scale: "medium",
      desc: "Build a modern e-commerce platform with payment integration, inventory management, and customer portal. Must be scalable and secure.",
      duration: "4 months",
      startDate: "2025-11-10",
      requirements: "5+ years experience in web development, E-commerce experience required, Payment gateway integration knowledge",
      deliverables: "Fully functional e-commerce website, Admin panel, Mobile responsive design, API documentation",
      skills: "React, Node.js, MongoDB, Stripe API, Redux",
      bidDeadline: "2025-11-05",
      urgency: "medium",
    ...
    },
    {
      ...
      scale: "large",
      desc: "Comprehensive security audit of our infrastructure, followed by implementation of security measures, penetration testing, and staff training.",
      duration: "8 months",
      startDate: "2025-12-01",
      requirements: "CISSP or CEH certification required, 7+ years in cybersecurity, Experience with compliance frameworks (ISO 27001, SOC 2)",
      deliverables: "Security audit report, Implemented security measures, Penetration test results, Security policies documentation",
      skills: "Network Security, Penetration Testing, SIEM, Firewall Configuration, Compliance",
      bidDeadline: "2025-11-20",
      urgency: "high",
    ...
    },
    {
      ...
      scale: "medium",
      desc: "Develop a cross-platform mobile application for food delivery service with real-time tracking, payment integration, and user reviews.",
      duration: "5 months",
      startDate: "2025-10-25",
      requirements: "React Native or Flutter experience, Published apps on App Store and Play Store, Experience with real-time features",
      deliverables: "iOS and Android apps, Backend API, Admin dashboard, App store deployment",
      skills: "React Native, Firebase, Google Maps API, Payment Integration, Push Notifications",
    ...
    },
    {
      ...
      company: "Anonymous Company E",
      companySize: "1000+",
      budget: "$100,000 - $200,000",
      budgetType: "fixed",
      domain: "Artificial Intelligence",
      scale: "enterprise",
      desc: "Build an AI-powered analytics platform that processes large datasets, provides predictive insights, and includes machine learning models for business intelligence.",
      duration: "10 months",
      startDate: "2025-12-15",
      requirements: "PhD or Masters in AI/ML, 8+ years experience, Experience with big data technologies, Published research preferred",
      deliverables: "Complete analytics platform, ML models, API documentation, Training materials, Deployment pipeline",
      skills: "Python, TensorFlow, PyTorch, Apache Spark, Kubernetes, Docker",
      bidDeadline: "2025-11-30",
      urgency: "medium",
    ...
    },
    {
      ...
      company: "Anonymous Company F",
      companySize: "51-200",
      budget: "$40,000 - $70,000",
      budgetType: "fixed",
      domain: "DevOps",
      scale: "medium",
      desc: "Automate our entire DevOps pipeline including CI/CD, infrastructure as code, monitoring, and automated testing across multiple environments.",
      duration: "4 months",
      startDate: "2025-11-05",
      requirements: "Strong DevOps experience, Kubernetes certification preferred, Experience with multi-cloud environments",
      deliverables: "Automated CI/CD pipeline, Infrastructure as code, Monitoring dashboards, Documentation",
      skills: "Jenkins, GitLab CI, Terraform, Ansible, Prometheus, Grafana",
      bidDeadline: "2025-10-28",
      urgency: "high",
